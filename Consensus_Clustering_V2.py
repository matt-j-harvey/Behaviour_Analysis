...
def reassign_pixel(pixel_x, pixel_y, image_height, imah )


def clean_consensus_clusters(pixel_assignments):

    print("Pixel Assignments", np.shape(pixel_assignments))
...
connectivity_matrix = np.where(connectivity_matrix > 0.85, connectivity_matrix, 0)
...
#np.save("/media/matthew/Expansion/Widefield_Analysis/Consensus_Clustering/Sorted_Connectivity_Matrix.npy", sorted_matrix)
